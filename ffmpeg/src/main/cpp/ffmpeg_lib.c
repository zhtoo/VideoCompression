...
Java_com_zht_ffmpeg_FFmpegNativeBridge_innerRunCommand(JNIEnv *env, jclass type,
...
Java_com_zht_ffmpeg_FFmpegNativeBridge_setDebug(JNIEnv *env, jclass type, jboolean debug) {
